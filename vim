...
map! <D-v> *
map p :vertical resize +10
map o :vertical resize -10
map i :resize +10
map u :resize -10
map m :vsp
map n :sp
...
map <C-W>p :vertical resize +10
map <C-W>o :vertical resize -10
map <C-W>i :resize +10
map <C-W>u :resize -10
map <C-W>m :vsp
map <C-W>n :sp
...
set helplang=en
set modelines=0
set runtimepath=~/.vim,~/.vim/plugged/emmet-vim,~/.vim/plugged/coc.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/after
set tabstop=4
set window=0
